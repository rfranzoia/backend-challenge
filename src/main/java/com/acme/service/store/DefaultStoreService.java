...
import com.acme.repository.StoreRepository;

/**
 * Service to encapsulate the link between DAO and controller and to have
 * business logic for some store specific things.
 * <p/>
 */
@Service
public class DefaultStoreService implements StoreService {
	 ...
	 * @param storeDO
	 * @return
	 * @throws ConstraintsViolationException if a store already exists with the
	 *                                       given license plate, ... .
	 */
	@Override
