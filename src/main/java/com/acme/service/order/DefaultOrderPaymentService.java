...
import com.acme.repository.OrderPaymentRepository;

/**
 * Service to encapsulate the link between DAO and controller and to have
 * business logic for some orderPayment specific things.
 * <p/>
 */
@Service
public class DefaultOrderPaymentService implements OrderPaymentService {
	 ...
	 * @throws EntityNotFoundException if no orderPayment with the given id was
	 *                                 found.
	 */
	@Override
	 ...
	 * @return
	 * @throws ConstraintsViolationException if a orderPayment already exists with
